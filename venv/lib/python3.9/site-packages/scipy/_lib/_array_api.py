...
def _asarray(array, dtype=None, order=None, copy=None, *, xp=None, check_finite=False):
...
def _strict_check(
    actual, desired, xp, check_namespace=True, check_dtype=True, check_shape=True
):
