...
from scipy._lib.deprecation import _NoValue, _deprecate_positional_args, _deprecated
...
def trapz(y, x=None, dx=1.0, axis=-1):
    ...
    """
    msg = (
        "'scipy.integrate.trapz' is deprecated in favour of "
...
@_deprecated(
    "`scipy.integrate.quadrature` is deprecated as of SciPy 1.12.0"
...
def cumtrapz(y, x=None, dx=1.0, axis=-1, initial=None):
    ...
    """
    msg = (
        "'scipy.integrate.cumtrapz' is deprecated in favour of "
...
def simps(y, x=None, dx=1.0, axis=-1, even=_NoValue):
    ...
    """
    msg = (
        "'scipy.integrate.simps' is deprecated in favour of "
...
@_deprecated(
    "`scipy.integrate.romberg` is deprecated as of SciPy 1.12.0"
    "and will be removed in SciPy 1.15.0. Please use"
    "`scipy.integrate.quad` instead."
)
def romberg(
